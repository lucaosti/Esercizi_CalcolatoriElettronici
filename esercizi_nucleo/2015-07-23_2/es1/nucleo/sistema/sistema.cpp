...
extern "C" void c_shmem_detach(natl);
//   ESAME 2015-07-23 )
...
// ( ESAME 2015-07-23
	for (des_attached *att = p->att; att; att = att->next)
		c_shmem_detach(att->id);
//   ESAME 2015-07-23 )
...
extern "C" void c_shmem_attach(natl id)
{
	...
	des_attached *att = new des_attached;
	if (!att) {
